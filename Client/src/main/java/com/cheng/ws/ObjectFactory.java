 ...
 * generated in the com.cheng.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://ws.cheng.com/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://ws.cheng.com/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cheng.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.cheng.com/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.cheng.com/", name = "queryWeatherResponse")
